  ...
  <div class="">
   ...
   <div class="collapse navbar-collapse navbar-left" id="myNavbar">
     <ul class="nav navbar-nav">
       ...
       <li><a href="#"><i class="fa fa-exchange fa-2x"></i> Tranfers</a></li>
       <li class="active"><a href="#"><i class="fa fa-money fa-2x"></i> Pay bills</a></li>
...
<div class="">
  <h5>Pay all your Utility bills in one place<small><img src="img/DStv.jpg" class="img-responsive"></small></h5>
    ...
    <div class="panel-body">
        ...
        <form method="post" action="">
            <select name="SelAcct" class="form-control">
                <option>Select Account to Pay from</option>
            ...
            <label for="bank"><strong>Pay to:</strong></label>
            <select name="bank" class="form-control">
                <option value="">DSTV</option>
                <option value="">Napa Bills</option>
                <option value="">Waka Now</option>
                <option value="">Startimes</option>
                <option value="">Gotv</option>
            </select>
            <label for="">Merchant ID:</label>
            <input type="text" class="form-control" required="true" size="10">
            <label>&nbsp;</label>
            
            <label for="pin">Rapido Pin: </label>
            <input type="number" name="pin" id="pin" class="">

            <input type="submit" value="Pay" name="send" class="form-control btn-success">
        </form>
