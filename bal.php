...
<html lang="en" ng-app="">
  <head>
    <meta charset="utf-8">
    <title>Rapido - Account Balance</title>
  ...
  <div class="">
   ...
   <div class="collapse navbar-collapse navbar-left" id="myNavbar">
     <ul class="nav navbar-nav">
       ...
       <li class="active"><a href="#"><i class="fa fa-bar-chart fa-2x"></i> Balance</a></li>
     </ul>
   </div>
    </div>
...
<div class="">
  <h5>Account Balance all in one Place<small></small></h5>
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
        <p>See indivual balance and saving culture.</p>
        <!-- Design the balance ui here -->
