  ...
  <div class="">
   ...
   <div class="collapse navbar-collapse navbar-left" id="myNavbar">
     <ul class="nav navbar-nav">
       ...
       <li class="active"><a href="#"><i class="fa fa-mobile fa-2x"></i> Buy Airtimes</a></li>
...
<div class="">
  <h5>Pay all your Utility bills in one place<small><img src="img/airtel.jpg" class="img-responsive"></small></h5>
    ...
    <div class="panel-body">
        ...
        <form method="post" action="">
            <select name="SelAcct" class="form-control">
                <option>Select Account to recharge from</option>
            ...
            <input type="submit" value="Buy" name="send" class="form-control btn-success">
        </form>
